...
am_rel_srcdir='.'
am_top_srcdir='/workspaces/labsisop-buildroot/output/build/host-automake-1.16.5'
am_top_builddir='/workspaces/labsisop-buildroot/output/build/host-automake-1.16.5'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/workspaces/labsisop-buildroot/output/host/share/automake-1.16/am'
    am_automake_acdir='/workspaces/labsisop-buildroot/output/host/share/aclocal-1.16'
    am_bindir='/workspaces/labsisop-buildroot/output/host/bin'
    am_datadir='/workspaces/labsisop-buildroot/output/host/share'
    am_docdir='/workspaces/labsisop-buildroot/output/host/share/doc/automake'
    am_pkgvdatadir='/workspaces/labsisop-buildroot/output/host/share/automake-1.16'
    am_scriptdir='/workspaces/labsisop-buildroot/output/host/share/automake-1.16'
    am_system_acdir='/workspaces/labsisop-buildroot/output/host/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/workspaces/labsisop-buildroot/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/workspaces/labsisop-buildroot/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/workspaces/labsisop-buildroot/output/host/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/workspaces/labsisop-buildroot/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/workspaces/labsisop-buildroot/output/host/include'}}
