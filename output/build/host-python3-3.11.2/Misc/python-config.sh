...
prefix_build="/workspaces/labsisop-buildroot/output/host"
...
CFLAGS=$(echo "-O2 -I/workspaces/labsisop-buildroot/output/host/include" | sed "s#^$prefix_build#$prefix_real#")
VERSION="3.11"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
