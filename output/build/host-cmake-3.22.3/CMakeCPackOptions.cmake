...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release\\CMakeInstall.bmp")
...
include("/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_TEMPLATE
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Source/QtIFW/installscript.qs.in")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_SCRIPT_GENERATED
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/CMake.qs")
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright;/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Copyright.txt")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/CMake.Dialogs.QtGUI.qs")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/CMake.Documentation.SphinxHTML.qs")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-DEVELOPER-REFERENCE-HTML_SCRIPT
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/CMake.DeveloperReference.HTML.qs")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/CMakeLogo.ico"
  )
  ...
  set(CPACK_WIX_UI_BANNER
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/install_dir.wxs"
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/workspaces/labsisop-buildroot/output/build/host-cmake-3.22.3/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
