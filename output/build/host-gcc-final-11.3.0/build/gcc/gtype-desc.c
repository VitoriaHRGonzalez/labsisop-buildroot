	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_stack_protector_guard_offset_str), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_stack_protector_guard_reg_str), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_stack_protector_guard_symbol_str), cookie);
}
